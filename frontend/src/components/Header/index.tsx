  ...
  return (
    <AnimatePresence>
      <motion.nav
        ...
        className={`${active ? 'absolute top-0': ''} w-full z-30 w-auto flex items-center flex-wrap glass p-3 `}
      >
        <motion.div
        ...
        >
          <motion.div
            ...
            className="lg:inline-flex md:gap-2 gap-5 lg:flex-row lg:ml-auto lg:w-auto lg:items-center items-start  flex flex-col  items-center"
          >
            {MenuData.map((m, i) => {
              return (
                <motion.div
