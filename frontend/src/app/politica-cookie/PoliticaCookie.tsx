...
export const PoliticaCookieComponent = () => {

    const site = dateLegale.site;


    return (
      <>
        <div className="prose m-auto bg-base-100 text-white p-10 prose-xl">
          ...
          <p>
            <b>
              1. Site-ul{' '}
              <Link href={String(dateLegale.siteHref)}>{dateLegale.site}</Link>{' '}
              utilizeaza cookie-uri.
            </b>
          </p>
          <p>
          ...
          <p>
            Acest website foloseşte cookie-uri proprii cât şi cookie-uri
            adăugate de terţi, pentru a furniza vizitatorilor o experienţă mult
            mai bună de navigare şi servicii adaptate nevoilor şi interesului
            fiecăruia.
          </p>
          <p>
            În ceea ce numim “web modern” sau “web 2.0″, cookie-urile joacă un
            rol important în facilitarea accesului şi livrării multiplelor
            servicii de care utilizatorul se bucură pe Internet, cum ar fi:
          </p>
          <p>
            <b>2. Ce este un “cookie”?</b>
          </p>
          <p>
            Un “Internet Cookie” (termen cunoscut şi ca “browser cookie” sau
            “HTTP cookie” ori pur şi simplu “cookie”) este un fişier de mici
            dimensiuni, format din litere şi numere, care va fi stocat pe
            computerul, terminalul mobil sau alte echipamente ale unui
            utilizator de pe care se accesează Internetul.
          </p>
          <p>
            Cookie-ul este trimis printr-o solicitare emisă de către web-server
            pe care este găzduit site-ul, către browser-ul utilizatorului (Ex:
            Firefox, Internet Explorer, Chrome etc.) şi este complet “pasiv”, în
            sensul că nu conţine programe software, viruşi sau spyware şi nici
            nu poate accesa informaţiile de pe hard driveul utilizatorului.
          </p>
          <p>
            ...
            accesa din nou, şi numai în momentul în care utilizatorul se
            întoarce pe site-ul asociat webserver-ului respectiv.
          </p>
          <p>
            Cookie-urile nu solicită informaţii cu caracter personal pentru a
            putea fi utilizate şi nici nu pot identifica personal utilizatorii
            de internet.
          </p>
          ...
          <ul>
            <li>
              <p>
                ...
                de cookie-uri al browserului web până când utilizatorul
                părăseşte siteul respectiv sau închide fereastra browserului.
              </p>
            </li>
            <li>
              <p>
                Cookie-uri persistente – acestea sunt stocate în computer sau
                echipamentul folosit pe hard pentru o perioadă mai lungă și
                rămân stocate inclusiv după părăsirea siteului sau după
                închiderea browserului web (iar în general depind de durata de
                viaţă prestabilită pentru cookie).
              </p>
            </li>
          </ul>
          <p>
            ...
            respectiv – cunoscute sub numele de “third party cookies”
            (cookie-uri plasate de terţi) – care pot fi folosite în mod anonim
            pentru a memora interesele unui utilizator, astfel încât să fie
            livrată publicitate cât mai relevantă pentru utilizator.
          </p>
          <p>
          ...
          <p>
            Cookie-urile sunt administrate de web-servere. Durata de viaţă a
            unui cookie poate varia semnificativ, depinzând de scopul pentru
            care este plasat. Unele cookie-uri sunt folosite exclusiv pentru o
            singură sesiune (“session cookies”) şi nu sunt reţinute după ce
            utilizatorul părăseşte site-ul, iar unele cookie-uri sunt reţinute
            şi refolosite de fiecare dată când utilizatorul revine pe acel site
          ...
          <p>
            Acest tip de cookie reţine preferinţele utilizatorului pe acest
            site, astfel încât nu mai este nevoie de setarea lor la fiecare
            vizitare a site-ului.
          </p>
          <p>
          ...
          <p>
            ...
            utilizatorului. Acest cookie ne spune dacă aţi mai vizitat acest
            site până acum. Browserul comunică dacă există acest cookie, iar
            dacă nu, este generat unul. Acest lucru permite monitorizarea
            utilizatorilor unici care vizitează site-ul şi cât de des o fac.
          </p>
          <p>
          ...
          <p>
            Când vă înregistraţi ori vă autentificaţi pe acest site, se
            generează un cookie care ne anunţă dacă sunteţi înregistrat sau nu.
            Server-ul nostru utilizează aceste cookie-uri pentru a identifica
            contul cu care sunteţi înregistrat şi dacă aveţi permisiunile
            necesare pentru un anumit serviciu ori pentru accesul la secţiuni
            ale site-ului. De asemenea, permite asocierea comentariilor pe care
            le postaţi pe site cu username-ul contului dvs. Dacă nu aţi selectat
            “păstrează-mă înregistrat”, acest cookie se va şterge automat când
            veţi închide browserul sau calculatorul.
          </p>
          <p>
          ...
          <p>
            ...
            customizarea unei aplicaţii. Datorită modului de utilizare, acest
            site nu poate accesa aceste cookie-uri, la fel cum terţele părţi nu
            pot accesa cookie-urile deţinute de acest site.
          </p>
          <p>Publicitatea online ce aparţine terţelor părţi</p>
          <p>
            Unele dintre acestea folosesc propriile cookie-uri anonime pentru a
            analiza câte persoane au vizualizat un mesaj publicitar, ori pentru
            a vedea câte persoane au vizualizat de mai multe ori aceeaşi
            reclamă.
          </p>
          <p>
          ...
          <p>
            Cookie-ul stochează informaţii importante care îmbunătaţesc
            experienţa de navigare pe Internet. Ex: setările privind limba în
            care se doreşte accesarea unui site, păstrarea unui user logat în
            contul de membru ori contul de mail, securitatea online, păstrarea
            şi memorarea unor setări etc.
          </p>
          <p>
            ...
            sunt doar mici fișiere text; nu sunt compilate sub formă de cod și
            nu pot fi executate. Astfel, nu se pot auto-copia, nu se pot
            răspândi în alte rețele pentru a genera acțiuni și nu pot fi
            folosite pentru răspândirea de viruși.
          </p>
          <p>
          ...
          <p>
            Cookie-urile pot asigura o interacțiune mai rapidă și mai ușoară
            între utilizatori și site-urile web. Spre exemplu, în momentul
            ...
            poate accesa respectivul site fără să fie nevoie să se autentifice
            din nou.
          </p>
          <p>
          ...
          <p>
            De asemenea, cookie-urile pot oferi site-urilor web posibilitatea de
            a monitoriza activitățile online ale utilizatorilor și de a stabili
          ...
          <p>
            ...
            primi publicitate online, ci doar că aceasta nu va mai putea ţine
            cont de preferinţele şi interesele dvs. evidenţiate prin
          ...
          <ul>
            ...
            <li>
              <p>
                Reţinerea filtrelor de protecţie a copiilor privind conţinutul
                pe Internet (opţiuni family mode, funcţii de safe search).
              </p>
            </li>
            <li>
              <p>
                Limitarea frecvenţei de difuzare a reclamelor – limitarea
                numarului de afişări a unei reclame pentru un anumit utilizator
                pe un site.
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                Măsurarea, optimizarea şi caracteristicile de analytics – cum
                sunt confirmarea unui anumit nivel de trafic pe un site, ce tip
                de conţinut este vizualizat mai mult şi modul cum un utilizator
          ...
          <p>
            În paginile website-ului {site}, prin intermediul unei etichete
            pentru remarketing ( remarketing tag) şi a unui cod de conversie,
            primite de la Google AdWords, sunt colectate cookie-uri (număr ce
            identifica în mod unic un browser web de pe un anumit computer, nu o
            persoană). Eticheta pentru remarketing Google colectează cookie-uri
            în vederea afişării unor anunţuri în website-urile reţelei Google
            Display şi în Google Search.
          </p>
          <p>
            ...
            adăugat unei liste pentru remarketing. O lista pentru remarketing
            este un set de module cookie de utilizator, generate de unasau de
            mai multe etichete pentru remarketing.
          </p>
          <p>
            ...
            {site} În cazul în care nu eşti de acord cu utilizarea modulelor
            cookie de către Google, dezactivarea se poate face prin Managerul
            preferinţelor anunţurilor
          </p>
          <p>
            <b>10. Securitatea şi problemele legate de confidenţialitate</b>
          </p>
          <p>
            Cookie-urile NU sunt viruşi! Ele folosesc un format de tip plain
            text. Nu sunt alcătuite din bucăţi de cod, aşa că nu pot fi
            executate şi nici nu pot auto-rula. În consecinţă, nu se pot duplica
            sau replica pe alte reţele pentru a rula sau replica din nou.
            Întrucât nu pot îndeplini aceste funcţii, nu pot fi considerate
            viruşi.
          </p>
          <p>
          ...
          <p>
            ...
            reprezintă dreptul fiecărui utilizator de internet, este indicat să
            se ştie care sunt eventuale probleme ce pot apărea în legătură cu
          ...
          <p>
            Alte atacuri bazate pe cookie implică setări greşite ale
            cookie-urilor pe servere.
          </p>
          <p>
          ...
          <p>
            ...
            broswer-ului folosit pentru navigarea pe Internet sunt disponibile
          ...
          <ul>
            ...
            <li>
              <a href="https://eur-lex.europa.eu/LexUriServ/LexUriServ.do?uri=OJ:L:2009:337:0011:0036:RO:PDF">
                ...
                și a Regulamentului (CE) nr. 2006/ 2004 privind cooperarea
                dintre autorităţile naţionale însărcinate să asigure aplicarea
            ...
            <li>
              <a href="https://www.w3.org/TR/tracking-dnt/">
                World Wide Web Consortium, Tracking Preferences Expression
                (DNT), W3C Working Draft, 2 Octombrie 2012
              </a>
            </li>
