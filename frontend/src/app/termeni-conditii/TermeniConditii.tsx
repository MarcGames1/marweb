...
const TermeniConditiiComponent = () => {
    ...
    <>
      <>
        <div className="prose m-auto bg-base-100 p-10 text-white prose-xl">
          <h1 className="text-center text-white">Termeni și condiții</h1>
          <p>
            Utilizarea Site-ului și achiziționarea Produselor, respectiv
            bunurile și serviciile digitale disponibile pe Site sunt
            reglementate de următorul set de Termene și condițiile (în
            continuare „TC” sau ”Contractul”), precum și de restul documentelor
            menționate în prezentul document, fiind aplicabile tuturor
            utilizatorilor, fie persoane fizice sau juridice, a site-ului {site}{' '}
            (denumit în continuare Site-ul sau platforma {brand}), cu excepția
            cazului în care se prevede altfel în prezentul document.
          </p>
          <p>
            Accesarea, utilizarea sau achiziționarea oricăror produse și
            servicii puse la dispoziția Dvs. pe platforma {site} este supusă
            acceptării următorului set de termene și condiții, ce formează
            Contractul dintre Societatea noastră, și dumneavoastră.
          </p>
          <p>
          ...
          <p>
            1.2 Beneficiarul este persoana fizică sau juridică care accesează
            sau utilizează site-ul sau achiziționează bunurile cu conținut
            digital sau serviciile digitale (denumite în continuare produse sau
            bunuri și servicii digitale) puse la dispoziție de către Prestator
            și se identifică prin datele sale care apar pe factura de comandă
            care se generează în momentul completării formularului de înscriere
            și este denumit în continuare Beneficiar, Cursant sau Utilizator.
          ...
          <ol>
            <li>
              <p>
                <b>Bunuri cu elemente digitale </b> – orice obiect corporal
                mobil care încorporează un conținut digital sau un serviciu
                digital sau este interconectat cu acestea, astfel încât, în
                absența respectivului conținut digital sau serviciu digital,
                bunurile nu și-ar putea îndeplini funcțiile;
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <b>Comerciant</b> – orice persoană fizică sau juridică,
                indiferent dacă este publică sau privată, care acționează în
                scopuri ce țin de activitatea comercială, industrială,
            ...
            <li>
              <p>
                ...
                de prestare de servicii la distanţă organizat, fără prezenţa
                fizică simultană a profesionistului şi a consumatorului, cu
                utilizarea exclusivă a unuia sau a mai multor mijloace de
                comunicare la distanţă, până la şi inclusiv în momentul în care
            ...
            <li>
              <p>
                ...
                <Link
                  href={'https://sintact.ro/#/dokument/79153932?cm=DOCUMENT'}
                >
                  2016/679
                </Link>{' '}
                ...
                <Link
                  href={'https://sintact.ro/#/dokument/79124701?cm=DOCUMENT'}
                >
                  95/46/CE
                </Link>
                ;{' '}
            ...
            <li>
              <p>
                <b>Preţ</b> – bani sau o reprezentare digitală a valorii
                datorate în schimbul furnizării de conţinut digital sau de
                servicii digitale;{' '}
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                ...
                care permite reproducerea neschimbată a informaţiilor stocate
                (de ex. adresa de poștă electronică){' '}
              </p>
            </li>
            <li>
              <p>
          ...
          <p>
            1. Obiectul Contractului îl reprezintă prestarea de servicii
            digitale și/sau furnizarea de bunuri cu conținut digital, constând
            în cursuri educaționale și de formare, de către Prestator din gama
            de produse prezentate pe platforma {brand} sau prin alte mijloace
            sau canale de comunicare, Beneficiarului, în schimbul unui preț, pe
            bază de comandă respectiv înscriere în conformitate cu clauzele
            prevăzute în prezentul contract.{' '}
          </p>
          <p>
            2.1. Specificațiile Bunurilor și Serviciilor digitale, ce fac
            obiectul prezentului Contract sunt comunicate de către Prestator
            Beneficiarului în detaliu fie prin publicare pe platformă sau în
            cadrul întâlnirii de informare și prezentare online stabilite între
            Beneficiar și reprezentanții Prestatorului.{' '}
          </p>
          <p>
            2.2. Prestatorul își îndeplinește obligația de livrare a bunurilor
            cu conținut digital în momentul în care bunul este transmis și
            predat către Beneficiar, la adresa menționată de către beneficiar.
          </p>
          <p>
            ...
            digital/serviciul digital devine accesibil pentru Beneficiar
            respectiv prin activarea contului de Utilizator pentru accesul pe
            platforma
          ...
          <p>
            ...
            conținut digital și/sau prestarea serviciilor digitale sunt supuse
            și reglementate de prezentul document, de contractul încheiat între
            părți, de politicile Societății, precum și de legislația aplicabilă
            în materie. Folosirea Site-ului, efectuarea comenzilor,
            achiziționarea și furnizarea Bunurilor și Serviciilor digitale nu
            sunt posibile în lipsa unui acord asupra Termenilor și Condițiilor.{' '}
            <b>
          ...
          <p>
            3.1 Prin acceptarea termenilor și condițiilor, respectiv prin
            comanda Beneficiarului și confirmarea comenzii de către Prestator,
            contractul se consideră încheiat între părți.
          </p>
          <p>
            {' '}
            3.2 Prezentul document are valoare de contract, fiind valabil
            încheiat la distanță, exclusiv prin utilizarea de mijloace de
            comunicare la distanță, fără prezența fizică simultană a părților și
            fără a fi necesară semnătura părților (olografă sau electronică).
            Pentru evitarea oricărui dubiu, Părțile convin că semnătura nu
          ...
          <p>
            4.4. Plata recurentă presupune că la data scadentă a fiecărei rate
            se va efectua automat plata de pe cardul introdus de către
            Beneficiar la prima comandă. Beneficiarul poate dezactiva în orice
            moment opțiunea de plată recurentă, cu un singur click, din contul
            de utilizator a Beneficiarului pe platforma Prestatorului.
          </p>
          <p>
            4.5. Prestatorul va emite Beneficiarului o factură pentru bunurile
            și serviciile digitale ce fac obiectul prezentului contract, scop în
            care Beneficiarul va furniza Prestatorului toate informațiile
            complete, corecte și actuale necesare emiterii facturii și a
            documentelor justificative prevăzute de lege.
          </p>
          <p>
            4.6. Factura pentru orice comandă (inclusiv pentru plățile
            recurente) va putea fi regăsită în contul de utilizator al
            Beneficiarului de pe platforma Prestatorului și descărcată de pe
            aceasta.
          </p>
          <h2 className="text-center">
          ...
          <p>
            Prestatorul are obligația să furnizeze bunurile și serviciile
            digital, ce fac obiectul prezentului Contract, cu îndeplinirea
            cerințelor prevăzute de normele legale aplicabile, în special
            prevăzute de OUG 140/2021 și OUG 141/2021. 5.2 Cerinţe subiective de
            conformitate Bunurile și serviciile digitale sunt în conformitate cu
            contractul dacă îndeplinesc următoarele condiţii:
          </p>
          <ol>
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                târziu în momentul încheierii contractului şi pe care
                Prestatorul l-a acceptat;
              </p>
            </li>
            <li>
              <p>
          ...
          <ol>
            <li>
              <p>
                Corespund scopurilor pentru care s-ar utiliza în mod normal
                bunuri / servicii digitale de acelaşi tip, ţinând seama, dacă
                este cazul, de prevederile legale în vigoare, de standarde
                tehnice sau, în absenţa unor astfel de standarde tehnice, de
                coduri de conduită aplicabile în domeniu şi specifice
                sectorului;
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                ...
                funcţionalitate, compatibilitate şi securitate, care sunt
                normale pentru bunurile de acelaşi tip şi la care Beneficiarul
                se poate aştepta în mod rezonabil, având în vedere natura
                bunului şi ţinând seama de orice declaraţie publică făcută de
                Prestator sau în numele acestuia;
              </p>
            </li>
            <li>
              <p>
                ...
                funcţionalitate, compatibilitate, accesibilitate, continuitate
                şi securitate, care sunt normale pentru conţinutul digital sau
                serviciile digitale de acelaşi tip şi la care Beneficiraul se
                poate aştepta în mod rezonabil, având în vedere natura
                conţinutului digital sau a serviciului digital şi ţinând seama
                de orice declaraţie publică făcută de Prestator sau în numele
                acestuia.{' '}
              </p>
            </li>
            <li>
              <p>
                este în conformitate cu orice versiune de testare sau prezentare
                a conținutului digital sau a serviciului digital pusă la
                dispoziție de Prestator înainte de încheierea contractului.
              </p>
            </li>
          </ol>
          <p>
            (2) Prestatorul nu este ţinut să respecte declaraţiile publice, în
            conformitate cu dispoziţiile alin. (1) lit. c) și lit. d) de mai
            sus, în cazul în care acesta demonstrează cel puţin una din
          ...
          <ol>
            ...
            <li>
              <p>
                decizia de a achiziţiona bunurile sau serviciile digitale nu ar
                fi putut fi influenţată de declaraţia publică.
              </p>
            </li>
          </ol>
          <p>
            ...
            anumite perioade, conținutul digital sau serviciul digital trebuie
            să fie conform pe întreaga durată a perioadei respective.
          </p>
          <p>
            (4) Nu există o neconformitate potrivit prevederilor alin. (1) și
            (2) dacă, la momentul încheierii contractului, Beneficiarul a fost
          ...
          <p>
            Orice neconformitate cauzată de instalarea incorectă a bunurilor
            este considerată ca reprezentând o neconformitate a bunurilor în una
            din următoarele situaţii:
          </p>
          <ol>
            <li>
              <p>
                instalarea face parte din contractul încheiat cu Prestatorul şi
                a fost realizată de Prestator sau sub răspunderea acestuia; r.
              </p>
            </li>
            <li>
              <p>
          ...
          <ol>
            ...
            <li>
              <p>
                ...
                integrat de Beneficiar, iar integrarea incorectă s-a datorat
                unor deficienţe în instrucţiunile de integrare furnizate de
                Prestator.
              </p>
            </li>
          </ol>
          ...
          <p>
            (1) În cazul bunurilor cu conținut digital, Prestatorul răspunde
            faţă de Beneficiar pentru orice neconformitate potrivit
            dispozițiilor legale aplicabile, respectiv pentru orice
            neconformitate care există în momentul livrării și care este
            constatată în termen de 2 ani de la data respectivă.
          </p>
          <p>
          ...
          <p>
            (1) În caz de neconformitate, Beneficiarul are dreptul la aducerea
            în conformitate a bunului, la o reducere proporţională a preţului
            sau la încetarea contractului în condiţiile prevăzute de
            dispozițiile legale aplicabile.
          </p>
          <p>
            (2) Pentru ca bunul să fie adus în conformitate, Beneficiarul poate
            opta între reparaţie şi înlocuire, cu excepţia cazului în care
            măsura corectivă aleasă ar fi imposibilă sau, în comparaţie cu
            cealaltă măsură corectivă disponibilă, ar impune Prestatorului
            costuri care ar fi disproporţionate, luând în considerare toate
            circumstanţele, inclusiv următoarele:
          </p>
          <ol>
            <li>
              <p>
            ...
            <li>
              <p>
                dacă măsura corectivă alternativă ar putea fi executată fără
                vreun inconvenient semnificativ pentru Beneficiar.
              </p>
            </li>
          </ol>
          <p>
            (3) Prestatorul poate refuza să aducă în conformitate bunul digital
            dacă reparaţia sau înlocuirea este imposibilă sau i-ar impune
            costuri care ar fi disproporţionate, luând în considerare toate
            circumstanţele, inclusiv cele prevăzute la alin. (2) lit. a) şi b).
          </p>
          <p>
            (4) Beneficiarul are dreptul fie să obţină o reducere proporţională
            a preţului în conformitate cu dispozițiile legale aplicabile, fie să
          ...
          <ol>
            <li>
              <p>
                Prestatorul nu a finalizat reparaţia sau înlocuirea în
                condițiile legii într-un termen rezonabil care nu poate depăși
                15 zile calendaristice sau Prestatorul a refuzat să aducă în
                conformitate bunurile potrivit prevederilor alin. (3) de mai
                sus;
              </p>
            </li>
            <li>
              <p>
                Se constată o neconformitate, în pofida eforturilor
                Prestatorului de a o remedia;
              </p>
            </li>
            <li>
              <p>
                Neconformitatea este de o asemenea gravitate încât justifică o
                reducere de preţ sau dreptul la încetarea imediată a
                contractului;
              </p>
            </li>
            <li>
          ...
          <p>
            ...
            momentul în care Prestatorul îşi va fi îndeplinit obligaţiile care
            îi revin potrivit legii.
          </p>
          <p>
            (7) Beneficiarul poate opta pentru o anumită măsură corectivă în
            cazul în care neconformitatea bunului digital este constatată la
            scurt timp după livrare, fără a depăşi 30 de zile calendaristice.
          </p>
          <h3 className="text-center">
          ...
          <h4>
            1. Măsurile corective în cazul nefurnizării conținutului /
            serviciilor digitale
          </h4>
          <p>
            ...
            îi va solicita Prestatorului să furnizeze serviciul digital. Dacă,
            în aceste circumstanţe, Prestatorul nu furnizează serviciul digital
            fără întârzieri nejustificate sau într-un termen suplimentar, astfel
            cum convin în mod expres părţile, Beneficiarul are dreptul să
            înceteze contractul.
          </p>
          <p>
            Dispozițiile de mai sus nu se aplică, iar Beneficiarul are dreptul
            să înceteze contractul direct, în una dintre următoarele situaţii:
          </p>
          <ol>
            <li>
              <p>
            ...
            <li>
              <p>
                Părțile au convenit că pentru Beneficiar este esenţială
                furnizarea la o anumită dată sau acest lucru reiese în mod clar
                din circumstanţele care însoţesc încheierea contractului, iar
                Prestatorul nu furnizează conţinutul digital sau serviciul
          ...
          <p>
            (1) În caz de neconformitate, Beneficiarul are dreptul la aducerea
            în conformitate a conținutului digital sau a serviciului digital, la
            o reducere proporţională a preţului sau la încetarea contractului în
            condiţiile prevăzute în prezentul articol.
          </p>
          <p>
            (2) Beneficiarul are dreptul la aducerea în conformitate a
            conţinutului digital sau a serviciului digital, cu excepţia cazului
            în care acest lucru ar fi imposibil sau ar impune Prestatorului
            costuri care ar fi disproporţionate, luând în considerare toate
          ...
          <p>
            ...
            către Beneficiar cu privire la neconformitate şi care este stabilit
            de comun acord, în scris, între părți, fără costuri şi fără vreun
          ...
          <p>
            (4) Beneficiarul are dreptul fie la reducerea proporţională a
            preţului în conformitate cu dispozițiile legale aplicabile, în cazul
            în care conţinutul digital sau serviciul digital este furnizat în
            schimbul plăţii unui preţ, fie la încetarea contractului în
            conformitate cu dispozițiile legale aplicabile, în oricare dintre
            următoarele cazuri:
          </p>
          <ol>
            <li>
          ...
          <p>
            ...
            serviciului digital furnizat Beneficiarului în comparaţie cu
            valoarea pe care serviciul digital ar avea-o dacă ar fi în
            conformitate.
          </p>
          <p>
            {' '}
            (6) Atunci când serviciul digital este furnizat în schimbul plăţii
            unui preţ, Beneficiarul are dreptul de a obţine încetarea
            contractului numai dacă neconformitatea nu este minoră.
          </p>
          <p>
            {' '}
            ...
            părţi a acesteia până la aducerea în conformitate de către Prestator
            a serviciului digital, cu condiţia ca plata suspendată să nu fie
          ...
          <p>
            ...
            conexe sau bunurilor neachitate. În această situație, Beneficiarul
            nu va beneficia de bonusul prevăzut în Contract.
          </p>
          <p>
            6.2.2. Să respecte întocmai regulile de comunicare stabilite de
            Prestator pe grupul de suport, oferit ca parte a pachetului de
            bonus, și să nu folosească un limbaj nepotrivit sau licențios pe
            acest grup la adresa Prestatorului sau a oricărui alt participant în
            cadrul grupului sau cursului, fiind interzisă acestuia postarea de
            mesaje scrise/verbale sau manifestarea unor atitudini apte de a
            provoca orice fel de daună sau ar periclita imaginea Prestatorului
            sau a oricărei alte persoane. Discuțiile și/sau argumentările se vor
            purta pe un ton colegial, mesajele care nu respectă aceste minime
            reguli de conduită urmând a fi eliminate de pe platformă fără a fi
            necesară vreo notificare prealabilă.
          </p>
          <p>
            {' '}
            ...
            orice fel sau a periclita imaginea acestuia ori sunt contrare
            normelor de drept, valorilor sociale/morale, ordinii publice sau
            bunelor moravuri, poate hotărî, după notificarea prealabilă a
            Beneficiarului, să scoată Beneficiarul din grupul de suport, fără a
            mai avea acces la acesta. Pentru înlăturarea oricărei îndoieli,
            Beneficiarul nu va avea dreptul de a pretinde restituirea prețului
            în astfel de situații.
          </p>
          <p>
            6.2.4. Să nu pună la dispoziția niciunui terţ, indiferent de metodă
            ori suport, cu titlu gratuit sau oneros, materialele/cursul sau
            părți ale acestuia pus la dispoziția sa de către Prestator prin
            accesul la platforma Prestatorului, Beneficiarul având exclusiv
            dreptul de a folosi materialele/cursul spre îmbunătățirea
            abilităților personale. În acest sens Beneficiarul este obligat să
            nu divulge userul și parola de conectare la contul de utilizator
            către terți, acestea fiind destinate strict pentru a fi utilizate de
            Beneficiar.
          </p>
          <p>
            ...
            confidențialitatea informațiilor și datelor la care are acces în
            baza prezentului Contract.
          </p>
          <p>
            6.2.6. Beneficiarul are dreptul să i se respecte confidențialitatea
            informațiilor și a datelor furnizate în temeiul prezentului
            Contract, inclusiv dreptul la confidențialitatea și protecția
          ...
          <p>
            {' '}
            6.2.8 În cazul încetării contractului Beneficiarul are obligația de
            a se abține de la utilizarea conținutului digital sau serviciului
          ...
          <p>
            Având în vedere prevederile OUG 34/2014, în situația în care
            Produsele respectiv bunurile și / sau serviciile digitale oferite de
            Prestator sunt achiziționate de comercianți, întrucât aceștia nu se
            încadrează în noțiunea de „consumator”, astfel cum acesta este
            definit de legislația în vigoare, dreptul de retragere nu este
            aplicabil.
          </p>
          ...
          <p>
            8.3. În cazul în care Beneficiarul-consumator, fără a exista vreun
            caz de neconformitate/nefurnizare a bunurilor și serviciilor
            digitale, decide în mod unilateral ca, după furnizarea bunului și
            serviciilor digitale de către Prestator, să nu utilizeze bunul
            digital sau să nu acceseze platforma și instrumentele digitale puse
            la dispoziție de Prestator, în temeiul prezentului Contract sau se
            răzgândește fără a exista un caz de neconformitate/nefurnizare,
            Beneficiarul nu este îndreptățit la restituirea prețului, iar dacă
            prețul a fost achitat numai parțial, obligațiile de plată asumate
            rămân valabile potrivit contractului. Prezenta prevedere nu va aduce
            atingere dreptului de retragere a Beneficiarului.{' '}
          </p>
          <p>
            ...
            serviciilor digitale de către Prestator, să nu utilizeze bunul
            digital sau să nu acceseze platforma și instrumentele digitale puse
            la dispoziție de Prestator, în temeiul Contractului sau se
            răzgândește, fără a exista un caz de culpă în executarea
            obligațiilor contractuale de către Prestator, Beneficiarul nu este
          ...
          <p>
            8.5. Pentru accesarea platformei Prestatorului este necesară
            existenta unei conexiuni la internet a Beneficiarului, Prestatorul
            nu poate garanta că serviciile oferite vor fi întotdeauna conforme
            cu dorințele Beneficiarului, neîntrerupte, la timp si fără erori,
            sau că erorile vor fi corectate în timp util, depinzând de
            furnizorul de servicii de internet a Beneficiarului, astfel
            Prestatorul nu poate fi ținut răspunzător pentru aceste
            disfuncționalități.{' '}
          </p>
          <p>
            8.6. Pentru utilizarea bunului digital, Beneficiarul va avea nevoie
            de o unitate CD/DVD-reader.{' '}
          </p>
          ...
          <p>
            ...
            utilizeze în nicio modalitate, fie direct, fie indirect, fie în
            folos propriu, fie în folosul altuia, niciun fel de materiale, acte,
            date, informații rezultate din/în legătură cu relația contractual
            dintre părți sau altor aspecte confidențiale aparținând
            Prestatorului, de care Beneficiarul a luat la cunoștință în orice
            mod pe durata contractului.{' '}
          </p>
          <p>
            ...
            Prestatorului, autorilor sau terților cu care Prestatorul are
            relații de afaceri sau privind activitatea acestora și care este
            transmisă de către Prestator în executarea Contractului, precum și
            orice împrejurare relevantă legată de Prestator (inclusiv, dar fără
            a se limita la cele prevăzute mai jos), indiferent dacă această
            informație a fost transmisă de către Prestator sau terți, primită de
            către Beneficiar în formă scrisă, orală sau în orice alt mod și care
            se referă inclusiv dar nelimitat la:
          </p>
          <ol>
            <li>
              <p>
          ...
          <p>
            ...
            sale contractuale și se obligă să nu le transmită terților,
            indiferent de motiv și indiferent de forma în care ar putea fi
            transmise.{' '}
          </p>
          <p>
            9.4 Beneficiarul este de acord cu folosirea imaginii, fotografiilor,
            vocii și a asemănării sale, denumite ”Informații personale”, de
            către Prestator în scopul promovării de către Prestator a
            serviciilor sale.{' '}
          </p>
          <p>
            9.5 Orice declarații sau interviuri, precum și dezvăluirea oricăror
            informații către media în legătură cu bunurile sau serviciile
            digitale furnizare de Prestator se poate face de Beneficiar numai cu
            acordul prealabil al Prestatorului, cu excepția situațiilor
          ...
          <p>
            ...
            modelelor de curs, precum și a oricărui material folosit de
            formatorii incluși în programul de curs, în timpul procesului de
            formare sunt proprietatea exclusivă a Prestatorului și sunt
            protejate de legislația în domeniul proprietății intelectuale.{' '}
          </p>
          <p>
            10.2. Denumirea, logo-ul, conținutul Site-ului, elementele grafice
            și de design, fotografiile, imaginile, semnele, textele, materialele
            video, precum și orice alte materiale transmise sub orice formă
            către Beneficiar (prin vizualizare directă pe site ori prin orice
            alte mijloace care aparțin sau au legătură cu Site-ul), precum și
            orice alte elemente ale site-ului sunt proprietatea Prestatorului și
            sunt protejate de legislația privind drepturile de proprietate
            intelectuală. Prin excepție, nu aparțin Prestatorului materialele,
            de orice natură, puse la dispoziția Utilizatorilor/Cursanților pe
            Site cu privire la care s-a indicat un alt titular de drepturi de
            proprietate intelectuală ori pentru care s-a arătat sursa
            materialului. {' '}
          </p>
          <p>
            ...
            Prestatorului, cu întregul conținut al acestora ori asupra, fără a
            se limita la acestea, suportului de curs, webinariilor, materialelor
            de învățare (de orice natură și sub orice formă), metodologiilor,
            bazelor de date, cursurilor, testelor online, temelor, conținutului
            ș.a.m.d. puse la dispoziție de către Prestator sau cu care
            Beneficiarul a avut contact cu prilejul furnizării Bunurilor și
            Serviciilor digitale (denumite Materiale).{' '}
          </p>
          <p>
            ...
            preluarea, reproducerea, publicarea, transmiterea, distribuirea
            totală sau parțială, în aceeași formă sau într-o formă modificată a
            Materialelor.{' '}
          </p>
          <p>
            ...
            menite să asigure protecția drepturilor de proprietate intelectuală
          ...
          <p>
            ...
            nici nu va desfășura, în mod direct sau indirect, el însuși,
            angajați ori interpuși ai acestuia, cu titlu gratuit sau cu titlu
            oneros, alte cursuri care au obiect identic sau similar cu cel pus
            la dispoziția sa de către Prestator.{' '}
          </p>
          <p>
            11.2. În măsura în care această obligație este încălcată,
            Beneficiarul va fi ținut să acopere prejudiciul generat
            Prestatorului.{' '}
          </p>
          ...
          <ol>
            ...
            <li>
              <p>
                ...
                aplicabilă în materia protecției consumatorilor. Beneficiarul
                îşi exercită dreptul de a înceta contractul printr-o declaraţie
                către Prestator prin care îşi exprimă decizia de a înceta
                contractul. Contractul încetează la data la care consumatorul
                transmite declaraţia către comerciant.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                încălcare a uneia sau mai multor obligații asumate prin
                Contract, cu notificarea prealabilă în vederea remedierii /
                executării obligațiilor, iar în caz de neexecutare în termen de
                15 zile de la primirea notificării, contractul se consideră
                rezoluționat, fără a mai fi necesară vreo altă formalitate.{' '}
              </p>
            </li>
          </ol>
          <p>
          ...
          <ol>
            ...
            <li>
              <p>
                ...
                remedierii/executării obligațiilor în termen de 5 zile și va
                avea posibilitatea de a suspenda furnizarea bunurilor și/sau
          ...
          <p>
            12.3. În cazul neachitării în termen a bunurilor și / sau
            serviciilor contractate, Prestatorul este absolvit de obligația
            furnizării bunurilor și serviciilor digitale comandate.{' '}
          </p>
          <p>
          ...
          <p>
            ...
            respective a fost cauzată de forța majoră, aşa cum este definită de
            lege.{' '}
          </p>
          <p>
          ...
          <p>
            13.3. Dacă în termen de 10 (zece) de zile de la producere
            evenimentul respectiv nu încetează, părțile au dreptul să-şi
            notifice încetarea de plin drept a prezentului contact fără ca
          ...
          <p>
            ...
            parteneriate, promovări şi/sau publicitate în legătură cu bunurile
            și serviciile digitale ce fac obiectul prezentului Contact revin
            exclusiv Prestatorului.
          </p>
          <p>
            14.3 În cazul neachitării în mod integral și cu respectarea
            termenului de scadență a bunurilor și serviciilor digitale
            comandate, conform prevederilor contractuale, Prestatorul este
            absolvit de obligația furnizării bunurilor și serviciilor digitale.
          </p>
          <p>
          ...
          <p>
            ...
            anularea comenzii sau suspendarea furnizării bunurilor sau
            serviciilor digitale în următoarele situații, fără a se limita la
            acestea:{' '}
          </p>
          <ol>
            <li>
            ...
            <li>
              <p>
                ...
                scopuri contrare prezentului Contract ori a legislației
                incidente;{' '}
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                ...
                interesele și/sau imaginea Prestatorului, a afiliaților săi ori
                a celorlalți Beneficiari;
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                Beneficiarul nu respectă instrucțiunile prevăzute pe Site
                privind efectuarea unei Comenzi și/sau utilizarea
                Site-ului/Produselor și Serviciilor digitale;{' '}
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                Beneficiarul încalcă (sau există suspiciuni rezonabile că
                încălca) drepturile de proprietate intelectuală și / sau
                confidențialitatea informațiilor ce aparțin Prestatorului.
              </p>
            </li>
          </ol>
          <p>
            14.6. Dacă situațiile prevăzute mai sus constituie o încălcare a
            legii și/sau au generat prejudicii Prestatorului, Prestatorul va
            avea dreptul de a sesiza autoritățile competente pentru sancționarea
            persoanei vinovate și, de asemenea, dreptul de a parcurge toate
            procedurile prevăzute de lege în vederea reparării în integralitate
            a prejudiciilor suferite, prezente sau viitoare.{' '}
          </p>
          ...
          <p>
            ...
            litigiu decurgând din sau în legătură cu prezentul contract,
            inclusiv referitor la încheierea, nulitatea, interpretarea,
            executarea sau desființarea acestuia, va fi soluționat definitiv de
            către instanțele de judecată de drept comun în cazul
            Beneficiarilor-consumatori și de către instanțele de judecată din
            Timișoara în cazul Beneficiarilor-comercianți.{' '}
          </p>
          <h2 className="text-center">Art.16. CLAUZE FINALE </h2>
          <p>
            16.1. Orice comunicare dintre părţi referitoare la prezentele
            termene şi condiţii poate fi transmisă prin e-mail sau scrisoare,
          ...
          <p>
            ...
            disponibilă în permanență, în mod gratuit, pe Site, Secțiunea
            „Termene și condiții”. {' '}
          </p>
          ...
          <p>
            <b>
              ...
              retragere aplicabilă pentru persoanele fizice – consumatori
              conform OUG 34/2014
            </b>
          </p>
          <p>
          ...
          <p>
            ...
            posesia fizică a bunurilor cu conținut digital.{' '}
          </p>
          <p>
            <b>Excepții: </b>
          </p>
          <p>
            Vă informăm că dreptul de retragere nu este aplicabil, printre
            altele, în oricare dintre următoarele situații: (i) după prestarea
            integrală a serviciilor sau (ii) pentru furnizarea de conținut
            digital care nu este livrat pe un suport material, dacă a început
            executarea contractului; (iii) furnizarea de înregistrări audio sau
            video sigilate sau de programe informatice sigilate care au fost
          ...
          <ol>
            <li>
              <p>
                ...
                Prestatorul nu este obligat la restituirea prețului în acest
                caz.{' '}
              </p>
            </li>
            <li>
              <p>
                ...
                confirmat că ați luat cunoştinţă de faptul că veți pierde
                dreptul de retragere în consecinţă. Astfel, după activarea
                contului dumneavoastră de utilizator în vederea accesării
                platformei nu mai aveți dreptul de retragere din contract, iar
                Prestatorul nu poate fi obligat la restituirea prețului.{' '}
              </p>
            </li>
          </ol>
          ...
          <p>
            ...
            dumneavoastră, fără întârzieri nejustificate şi, în orice caz, nu
            mai târziu de 14 zile de la data la care suntem informaţi cu privire
            la decizia dumneavoastră de a vă retrage din prezentul contract.{' '}
          </p>
          <p>
            Vom efectua această rambursare folosind aceeaşi modalitate de plată
            ca şi cea folosită pentru tranzacţia iniţială, cu excepţia cazului
            în care v-aţi exprimat acordul expres pentru o altă modalitate de
          ...
          <p>
            <b>
              Prezentul formular se completează, se semnează și se transmite
              către Prestator numai dacă doriți să vă retrageți din contract.
            </b>
          </p>
          <p>
            Către {dateFirma.nume} cu sediul in {dateFirma.sediuSocial} adresa
            de email {dateFirma.email}
          </p>
          ...
          <p>
            Vă informez prin prezenta cu privire la retragerea mea din
            contractul referitor la furnizarea următoarelor servicii / produse:
          </p>
          <p>………………………………</p>
          <p>
            {' '}
...
export default TermeniConditiiComponent;
