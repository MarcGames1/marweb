            ...
            <div className="py-12 px-5">
                ...
                {posts.map(post => (
                    ...
                    >
                        ...
                        <Link  href={`${post.permalink}`}><Image className=" " src={post.thumbnail} width={300} height={300}  alt={post.title}/></Link>
